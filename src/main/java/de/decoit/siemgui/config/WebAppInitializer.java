...
import de.decoit.siemgui.ext.icinga.dbconnector.IcingaConnectorConfig;
...
public class WebAppInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	protected Class<?>[] getRootConfigClasses() {
		return new Class<?>[]{RootConfig.class, PersistenceConfig.class, CorrelationDbConfig.class, IcingaConnectorConfig.class, WebSecurityConfig.class, WebSocketConfig.class};
	}
