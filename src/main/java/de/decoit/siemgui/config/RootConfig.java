...
public class RootConfig {
	...
	public SystemConfig getSystemConfig() {
		...
		sysconf.setRulesWebServiceUrl(env.getProperty("rule.webservice.url"));
		sysconf.setEventsPageSize(env.getProperty("events.pagesize", Integer.class));
	...
	public static class SystemConfig {
		...
		private String rulesWebServiceUrl;
